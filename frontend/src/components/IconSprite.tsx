...
export default function IconSprite() {
  return (
    ...
    >
      ...
      {/* alert / warning triangle (autosave failure) */}
      ...
      {/* bug — DEV-only "throw a test error" affordance in TopBar (used
          to verify Sentry capture from the running app). Lucide bug glyph. */}
