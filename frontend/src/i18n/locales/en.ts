const en = {
  ...
  onboarding: {
    ...
    startBtn: 'Start →',
    exampleBtn: 'Load example (Restalia)',
  ...
  report: {
    ...
    results: {
      ...
      progressItems: {
        scenarios: '3P scenarios and narratives',
        scenarioPlanning: 'Driving forces and impact matrix',
        backcasting: 'Backcasting per scenario',
        strategicMap: 'Strategic map H1/H2/H3',
