...
export default function NewReportPage() {
  ...
  const languageRef = useRef<LanguageCode>('es');
  ...
  // page free of the 250-line spec array; the specs live alongside their
  // tests in features/report/hooks/useWizardCommands.ts.
  useWizardCommands({
    step,
    editMode,
    editingId,
